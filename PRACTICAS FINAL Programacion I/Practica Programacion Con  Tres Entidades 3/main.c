...
int main()
{
    ...
    eEntidad* entidadDos = entidad_newParametros(11, 6, "entidadDos");
    eEntidad* entidadTres = entidad_newParametros(12, 7, "entidadTres");


    //mostrar(entidad);

    guardarEnBinario("entidades.txt", entidadUno);
    guardarEnBinario("entidades.txt", entidadDos);
    guardarEnBinario("entidades.txt", entidadTres);
