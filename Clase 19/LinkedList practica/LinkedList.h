...
///pasamos un alista,un indice y el get me dice cuales el objeto que hay en ese indice
//--------------------------------------------------------------------------------------
...
///pso un elemento y me dice si esta en la lsita
//--------------------------------------------------------------------------------------
int ll_containsAll(LinkedList* this,LinkedList* this2);
///mustra que elementos tengo en la lista
//--------------------------------------------------------------------------------------
LinkedList* ll_subList(LinkedList* this,int from,int to);
///duvuelve una sub lista de un elemento determinado a otro
//--------------------------------------------------------------------------------------
